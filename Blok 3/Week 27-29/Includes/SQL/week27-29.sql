...
INSERT INTO `begeleiders` (`id`, `name`) VALUES
(1, 'John'),
(2, 'Jacob'),
(3, 'Alice'),
(4, 'Mark'),
...
INSERT INTO `games` (`id`, `name`, `image`, `description`, `expansions`, `skills`, `url`, `youtube`, `min_players`, `max_players`, `play_minutes`, `explain_minutes`, `begeleider_id`) VALUES
...
--
-- AUTO_INCREMENT voor een tabel `begeleiders`
--
ALTER TABLE `begeleiders`
